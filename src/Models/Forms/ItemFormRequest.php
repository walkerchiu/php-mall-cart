    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if ( config('wk-mall-cart.onoff.mall-shelf') && !empty(config('wk-core.class.mall-shelf.stock')) ) {
                ...
                if ( isset($data['channel_id']) && isset($data['user_id']) ) {
                    ...
                    foreach ($records as $record) {
                        ...
                        if (empty($record->binding)) continue;
                ...
                if ( isset($data['stock_id']) && isset($data['nums']) ) {
                    ...
                    if ( isset($data['binding']) && is_iterable($data['binding']) ) {
